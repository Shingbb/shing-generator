...
import FileConfigForm from '@/pages/Generator/Add/conponents/FileConfigForm';
import GeneratoeMaker from '@/pages/Generator/Add/conponents/GeneratorMaker';
import ModelConfigForm from '@/pages/Generator/Add/conponents/ModelConfigForm';
import {
